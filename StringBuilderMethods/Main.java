...
public class Main {
    public static void main(String[] args) {
        ...
        bf.isEmpty(); // return ture if string is empty

        System.out.println(bf.length()); // return the string length

        System.out.println(bf.substring(4)); // return substring form 4 to end of the stirng
        ...
        bf.reverse(); // it reverse the whole string
